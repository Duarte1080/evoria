...
ESX.RegisterUsableItem('bread', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~pain")
end)
...
ESX.RegisterUsableItem('chocolate', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~chocolat")
end)
...
ESX.RegisterUsableItem('sandwich', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~sandwich")
end)
...
ESX.RegisterUsableItem('hamburger', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'thirst', 70000)
	TriggerClientEvent('esx_basicneeds:onEat', source)
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~hamburger")
end)
...
ESX.RegisterUsableItem('cupcake', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~cupcake")
end)
...
ESX.RegisterUsableItem('chips', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~chips")
end)
...
ESX.RegisterUsableItem('water', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~eau")
end)
...
ESX.RegisterUsableItem('cocacola', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~coca cola")
end)
...
ESX.RegisterUsableItem('icetea', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~icetea")
end)
...
ESX.RegisterUsableItem('coffe', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~café")
end)
...
ESX.RegisterUsableItem('wine', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~vin")
end)
...
ESX.RegisterUsableItem('beer', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~biere")
end)
...
ESX.RegisterUsableItem('vodka', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~vodka")
end)
...
ESX.RegisterUsableItem('whisky', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~whisky")
end)
...
ESX.RegisterUsableItem('tequila', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~tequila")
end)
...
ESX.RegisterUsableItem('milk', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~lait")
end)
...
ESX.RegisterUsableItem('champagne', function(source)
	...
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~champagne")
end)
...
ESX.RegisterUsableItem('cigarett', function(source)
	...
	local lighter = xPlayer.getInventoryItem('lighter')
		...
		if lighter.count > 0 then
			...
			TriggerClientEvent('esx:showNotification', source, 'Vous n\'avez pas de cigarette')
		end
end)
...
ESX.RegisterUsableItem('fanta', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'drunk', 50000)
	TriggerClientEvent('esx_basicneeds:onDrinkFanta', source)
	TriggerClientEvent('esx:showNotification', source, "vous avez utilisé ~g~x ~y~1 ~b~fanta")
end)
