...
Config.SwitchGaragePrice		= 10000000000000000000000000 -- price to pay to switch vehicles in garage
...
Config.Blips = {
	...
	Blips = {
		Pos = {
			{x = 215.800, y=-810.057, z=30.727},
			{x = -1523.191,y = -451.017,z = 35.596},
			{x = 105.359, y=6613.586, z=32.3973},
			{x = 1694.571, y=3610.924, z=35.319},
			{x = -3140.323,y = 1124.463,z = 20.706},
			{x = -2982.561,y = 327.506,z = 14.935},
			{x = 443.6696,y = -1969.4372,z = 24.401},
			{x = -73.165,y = 908.087,z = 235.627},
			{x = -739.965,y = -75.616,z = 41.747 },
			{x = -69.514,y = -1822.947,z = 26.941},
			{x = -2080.948,y = -483.592,z = 11.103},
		}
	}		
}
...
Config.Garages = {
	...
	Garage_mirrorpark = {
	 ...
	 Garage_pdm = {
		 Pos = {x = -760.760,y = -239.539,z = 37.241 },
		 Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		 Name = 'Garage',
		 HelpPrompt = 'Appuyer sur ~INPUT_PICKUP~ pour ouvrir le garage',
		 Functionmenu = OpenMenuGarage,
		 SpawnPoint = {
			 Pos = {x = -768.576,y = -245.766,z = 37.249 },
			 Heading = 264.63,
			 Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			 HelpPrompt = 'Appuyer sur ~INPUT_PICKUP~ pour sortir votre véhicule',
		 ...
		 DeletePoint = {
			 Pos = {x = -763.9060,y = -242.8548,z = 37.2366 },
			 Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			 HelpPrompt = 'Appuyer sur ~INPUT_PICKUP~ pour rentrer votre véhicule',
	...
	police =  { -- database job name
		{
			...
			Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
			Name = 'Garage de police',
			HelpPrompt = 'Appuyez sur ~ INPUT_PICKUP ~ pour ouvrir le garage de la police',
			SpawnPoint = {
				Pos = {x = -1285.1153564453,y = -3382.1647949219,z = 13.940155029297 },
				Heading = 160.0,
				Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
				HelpPrompt = 'Appuyez sur ~ INPUT_PICKUP ~ pour sortir un véhicule du garage de la police'
			},
			DeletePoint = {
				Pos = {x = -1287.5788574219,y = -3390.4025878906,z = 13.940155029297 },
				Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
				HelpPrompt = 'Appuyez sur ~ INPUT_PICKUP ~ pour rentrer votre dans le garage de la police'
			}, 	
		},
		{
	...
	brinks =  {
		{
			...
			Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
			Name = 'Brinks Garage',
			HelpPrompt = 'Appuyez sur ~ INPUT_PICKUP ~ pour ouvrir le garage Brinks',
			SpawnPoint = {
				Pos = {x = -1285.1153564453,y = -3382.1647949219,z = 13.940155029297 },
				Heading = 160.0,
				Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
				HelpPrompt = 'Appuyez sur ~ INPUT_PICKUP ~ pour sortir un véhicule du garage Brinks'
			},
			DeletePoint = {
				Pos = {x = -1287.5788574219,y = -3390.4025878906,z = 13.940155029297 },
				Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
				HelpPrompt = 'Appuyez sur ~ INPUT_PICKUP ~ pour ranger le véhicule dans le garage Brinks'
			}, 	
		},
    },
	ambulance =  {
		{
			Pos = {x = 443.1153564453,y = -993.86,z = 30.696 },
			Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
			Name = 'Garage d\'ambulance',
			HelpPrompt = 'Appuyez sur ~ INPUT_PICKUP ~ pour ouvrir le garage d\'ambulance',
			SpawnPoint = {
				Pos = {x = -1285.1153564453,y = -3382.1647949219,z = 13.940155029297 },
				Heading = 160.0,
				Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
				HelpPrompt = 'Appuyez sur ~ INPUT_PICKUP ~ pour sortir un véhicule du garage ambulance'
			},
			DeletePoint = {
				Pos = {x = -1287.5788574219,y = -3390.4025878906,z = 13.940155029297 },
				Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
				HelpPrompt = 'Appuyez sur ~ INPUT_PICKUP ~ pour ranger le véhicule dans le d\'ambulance'
			}, 	
		},
	},
	taxi =  {
		{
			...
			Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
			Name = 'Garage Taxi',
			HelpPrompt = 'Appuyez sur ~ INPUT_PICKUP ~ pour ouvrir le garage Taxi',
			SpawnPoint = {
				Pos = {x = -1285.1153564453,y = -3382.1647949219,z = 13.940155029297 },
				Heading = 160.0,
				Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
				HelpPrompt = 'Appuyez sur ~ INPUT_PICKUP ~ pour sortir un véhicule du garage Taxi'
			},
			DeletePoint = {
				Pos = {x = -1287.5788574219,y = -3390.4025878906,z = 13.940155029297 },
				Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
				HelpPrompt = 'Appuyez sur ~ INPUT_PICKUP ~ pour ranger le véhicule dans le garage Taxi'
			}, 	
		},
    },
}
