local PlayerData, CurrentActionData, dragStatus, blipsCops, currentTask, spawnedVehicles = {}, {}, {}, {}, {}, {}, {}
...
function OpenCloakroomMenu()
	...
	if grade == 'cadet' then
		table.insert(elements, {label = 'tenue de servise', value = 'cadet_wear'})
	elseif grade == 'officier' then
		table.insert(elements, {label = 'tenue de servise', value = 'officier_wear'})
	elseif grade == 'officierI' then
		table.insert(elements, {label = 'tenue de servise', value = 'officierI_wear'})
	elseif grade == 'officierII' then
		table.insert(elements, {label = 'tenue de servise', value = 'officierII_wear'})
	elseif grade == 'officierIII' then
		table.insert(elements, {label = 'tenue de servise', value = 'officierIII_wear'})
	elseif grade == 'officiersenoir' then
		table.insert(elements, {label = 'tenue de servise', value = 'officiersenoir_wear'})
	elseif grade == 'Sergent' then
		table.insert(elements, {label = 'tenue de servise', value = 'Sergent_wear'})
	elseif grade == 'SergentII' then
		table.insert(elements, {label = 'tenue de servise', value = 'SergentII_wear'})
	elseif grade == 'lieutenant' then
		table.insert(elements, {label = 'tenue de servise', value = 'lieutenant_wear'})
	elseif grade == 'lieutenantII' then
			table.insert(elements, {label = 'tenue de servise', value = 'lieutenantII_wear'})
	elseif grade == 'captaine' then
			table.insert(elements, {label = 'tenue de servise', value = 'captaine_wear'})
	elseif grade == 'boss' then
			table.insert(elements, {label = 'tenue de servise', value = 'boss_wear'})
	elseif grade == 'agentsecret' then
			table.insert(elements, {label = 'tenue de servise', value = 'agentsecret_wear'})
	elseif grade == 'chef' then
			table.insert(elements, {label = 'tenue de servise', value = 'che_wear'})
	end
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if
			...
			data.current.value == 'officier_wear' or
			data.current.value == 'officierI_wear' or
			data.current.value == 'officierII_wear' or
			data.current.value == 'officierIII_wear' or
			data.current.value == 'officiersenoir_wear' or
			data.current.value == 'sergent_wear' or
			data.current.value == 'sergentII_wear' or
			data.current.value == 'lieutenant_wear' or
			data.current.value == 'lieutenantII_wear' or
			data.current.value == 'captaine_wear' or
			data.current.value == 'boss_wear' or
			data.current.value == 'agentsecret_wear' or
...
function OpenVehicleSpawnerMenu(type, station, part, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		elseif data.current.action == 'garage' then
			...
			ESX.TriggerServerCallback('pdmshop:retrieveJobVehicles', function(jobVehicles)
						...
						if data2.current.stored then
							...
							if foundSpawn then
								...
								ESX.Game.SpawnVehicle(data2.current.model, spawnPoint.coords, spawnPoint.heading, function(vehicle)
									...
									TriggerServerEvent('pdmshop:setJobVehicleState', data2.current.vehicleProps.plate, false)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm', {
			...
			if data2.current.value == 'yes' then
				local newPlate = exports['pdmshop']:GeneratePlate()
...
RegisterNetEvent('NB:police')
AddEventHandler('NB:police', function()
	Opensacpolice()
end)