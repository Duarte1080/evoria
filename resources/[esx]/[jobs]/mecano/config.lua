...
Config.mecanoStations = {
	...
	Mecano = {
		...
		Blip = {
			Coords  = vector3(728.6563, -1068.8765, 28.3110),
			Sprite  = 446,
			Display = 4,
			Scale   = 0.8,
			Colour  = 5
		...
		Cloakrooms = {
			vector3(725.535, -1066.629, 28.3110)
		},

		coffre = {
			vector3(724.9473, -1074.108, 28.3110)
		},

		Vehicles = {
			{
				Spawner = vector3(-193.0461, -1287.3637, 31.287),
				InsideShop = vector3(-184.2929, -1289.34, 31.29),
				SpawnPoints = {
					{ coords = vector3(-180.1804, -1288.5895, 31.2959), heading = 177.1401, radius = 6.0 },
					{ coords = vector3(-180.1804, -1288.5895, 31.2959), heading = 177.1401, radius = 6.0 },
					{ coords = vector3(-180.1804, -1288.5895, 31.2959), heading = 177.1401, radius = 6.0 },
					{ coords = vector3(-180.1804, -1288.5895, 31.2959), heading = 177.1401, radius = 6.0 },
				}
		...
		BossActions = {
			vector3(725.7423, -1071.195, 28.3110)
		}
