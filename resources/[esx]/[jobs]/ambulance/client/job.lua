...
function Opensacmedic()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'mobile_ambulance_actions', {
		...
		elements = {
			...
			{label = 'Déposer un fauteuil',    value = 'addu'},
			{label = 'Ramasser le fauteuil',    value = 'remove'},
		}
	}, function(data, menu)

		if data.current.value == 'addu' then
		...
		if data.current.value == 'citizen_interaction' then
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				elements = {
					...
					{label = 'soigner petites blessures', value = 'small'},
					{label = 'soigner blessures graves', value = 'big'}
				}
			}, function(data, menu)
...
Citizen.CreateThread(function()
	while true do
		...
		for hospitalNum,hospital in pairs(Config.Hospitals) do
			...
			-- menu
			for k,v in ipairs(hospital.MenuBoss) do
				local distance = GetDistanceBetweenCoords(playerCoords, v, true)
				...
				if distance < Config.Marker.x then
					isInMarker, currentHospital, currentPart, currentPartNum = true, hospitalNum, 'Menuboss', k
				end
			end
...
AddEventHandler('esx_ambulancejob:hasEnteredMarker', function(hospital, part, partNum)
	if ESX.PlayerData.job and ESX.PlayerData.job.name == 'ambulance' then
		if part == 'AmbulanceActions' then
			CurrentAction = part
			CurrentActionMsg = 'Vestiaire'
			CurrentActionData = {}
		elseif part == 'Menuboss' then
			CurrentAction = part
			CurrentActionMsg = 'Menuboss'
			CurrentActionData = {}
	...
	while true do
		...
		if CurrentAction then
			...
			if IsControlJustReleased(0, Keys['E']) then
				...
				elseif CurrentAction == 'Menuboss' then
					OpenMenubossMenu()
...
RegisterNetEvent('NB:medic')
AddEventHandler('NB:medic', function()
	Opensacmedic()
end)